...
RSpec.describe 'PostRoomUserProfile', type: :request do
  ...
  context do
    before { post '/api/profile/communes/1/rooms/1/join', params: params.to_json , headers: headers }
  ...
  context 'Record was not found' do
    before { post '/api/profile/communes/1/rooms/0/join', params: params.to_json , headers: headers }
