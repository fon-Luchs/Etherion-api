...
RSpec.describe 'PostUserAdLike', type: :request do
  ...
  context do
    before { post '/api/users/1/headings/1/ads/1/comments/1/like', params: params.to_json , headers: headers }
  ...
  context 'invalid params' do
    before { post '/api/users/1/headings/1/ads/1/comments/1/like', params: {}, headers: headers }
