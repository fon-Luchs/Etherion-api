...
RSpec.describe Session::Session do
  let(:password) { FFaker::Internet.password }

  let(:email) { FFaker::Internet.email }

  subject { Session::Session.new email: email, password: password }
  ...
  describe '#valid?' do
    let(:session) { Session::Session.new email: email, password: password }
